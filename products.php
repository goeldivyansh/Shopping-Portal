...
<body style="padding-top: 50px;">
    ...
    <div class="container">
        <!-- Jumbotron Header -->
            <div class="jumbotron home-spacer" id="products-jumbotron" style="background-color: #DAE0E2; color: #2C3335;">
            ...
            <div class="col-sm-3" >
               ...
               <div class="panel panel-default">
                    <div class="panel-heading color">
                        <h3 style="color:#2C3335">Brands</h3>
                    </div>
               ...
               <br>
                <div class="panel panel-default">
                    <div class="panel-heading  color">
                        <h3 style="color:#2C3335">Operating System</h3>
                    </div>
            ...
            <div class="col-sm-9 text-center">
                <div class="panel-group">
                  <!----------------------------------------------------featured phone----------------------------------->
                   <div class="panel panel-default">
                        <div class="panel-heading  color">
                            <h3 style="color:#2C3335">Featured Mobile</h3>
                        </div>
                                ...
                                <img src="./img/iphonex.png" alt="iphone x" >
                                    <div class="caption">
                                        ...
                                        <p>Price: Rs. 36000.00 </p>
                                            ...
                                            <p><a href= "#" data-toggle="modal" data-target="#loginmodal" role="button" class="btn btn-info btn-block">Buy Now</a></p>
                                                <?php
                                            } else {
                ...
                <div class="panel panel-default">
                        <div class="panel-heading  color">
                            <h3 id="ios" style="color:#2C3335">apple</h3>
                        </div>
                ...
                <div class="panel panel-default">
                        <div class="panel-heading  color">
                            <h3 id="samsung" style="color:#2C3335">samsung</h3>
                        </div>
                ...
                <div class="panel panel-default">
                        <div class="panel-heading  color">
                            <h3 id="oneplus" style="color:#2C3335">oneplus</h3>
                        </div>
                   ...
                   <div class="panel panel-default">
                        <div class="panel-heading  color">
                            <h3 id="xiaomi" style="color:#2C3335">xiaomi</h3>
                        </div>
